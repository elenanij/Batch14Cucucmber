...
public class EmployeeSearchSteps extends CommonMethods {
    ...
    public void user_enters_valid_employee_id() {
       ...
       sendText(employeeList.empSearchIdField, ConfigReader.getPropertyValue("empID"));
    }
    ...
    public void user_enters_valid_employee_name() {
        ...
        sendText(employeeList.empSearchNameField, ConfigReader.getPropertyValue("empName"));
    }
